...
{	
    ...
    node = rclcpp::Node::make_shared("xarm_simple_planner_pose_test");
    RCLCPP_INFO(node->get_logger(), "xarm_simple_planner_pose_test start");
    ...
    RCLCPP_INFO(node->get_logger(), "xarm_simple_planner_pose_test over");
    return 0;
}