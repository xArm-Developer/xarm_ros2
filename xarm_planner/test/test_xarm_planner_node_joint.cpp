...
{	
    ...
    node = rclcpp::Node::make_shared("xarm_planner_node_test_joint", node_options);
    RCLCPP_INFO(node->get_logger(), "xarm_planner_node_test_joint start");
    ...
    RCLCPP_INFO(node->get_logger(), "xarm_planner_node_test_joint over");
    return 0;
}