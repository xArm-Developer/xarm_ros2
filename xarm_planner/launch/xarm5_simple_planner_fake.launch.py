...
sys.path.append(os.path.join(package_path, 'launch', 'lib'))
from xarm_moveit_config_lib import get_xarm_moveit_fake_launch_description, load_file, load_yaml
...
def generate_launch_description():
    ...
    xarm_moveit_launch_description = get_xarm_moveit_fake_launch_description(
