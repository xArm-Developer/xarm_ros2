...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_description'), 'launch', '_stevensARM_description.launch.py'])),
        launch_arguments={
            'prefix': prefix,
            'hw_ns': hw_ns,
            'limited': limited,
    ...
    robot_moveit_common_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_moveit_config'), 'launch', '_stevensARM_moveit_common.launch.py'])),
        launch_arguments={
            'prefix': prefix,
            'hw_ns': hw_ns,
            'limited': limited,
    ...
    if add_gripper.perform(context) in ('True', 'true') and robot_type.perform(context) == 'xarm':
        remappings.append(
            ('follow_joint_trajectory', '{}IDM_traj_controller/follow_joint_trajectory'.format(prefix.perform(context)))
        )
        controllers.append('{}IDM_traj_controller'.format(prefix.perform(context)))
    ...
    ros2_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_controller'), 'launch', '_stevensARM_ros2_control.launch.py'])),
        launch_arguments={
            'prefix': prefix,
            'hw_ns': hw_ns,
            'limited': limited,
