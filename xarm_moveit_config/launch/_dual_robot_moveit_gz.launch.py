...
def launch_setup(context, *args, **kwargs):
    ...
    # robot gazebo launch
    # xarm_gazebo/launch/_dual_robot_beside_table_gz.launch.py
    robot_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_gazebo'), 'launch', '_dual_robot_beside_table_gz.launch.py'])),
        launch_arguments={
            'dof_1': dof_1,
            'dof_2': dof_2,
            'robot_type_1': robot_type_1,
