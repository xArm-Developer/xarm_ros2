...
def launch_setup(context, *args, **kwargs):
    ...
    mod = load_python_launch_file_as_module(os.path.join(get_package_share_directory(moveit_config_package_name), 'launch', 'lib', 'stevensIDM_moveit_config_lib.py'))
    get_xarm_robot_description_parameters = getattr(mod, 'get_xarm_robot_description_parameters')
    robot_description_parameters = get_xarm_robot_description_parameters(
        xacro_urdf_file=PathJoinSubstitution([FindPackageShare('xarm_description'), 'urdf', 'stevensIDM_device.urdf.xacro']),
        xacro_srdf_file=PathJoinSubstitution([FindPackageShare('xarm_moveit_config'), 'srdf', 'stevensIDM.srdf.xacro']),
        urdf_arguments={
            'prefix': prefix,
    ...
    controllers_yaml = load_yaml(moveit_config_package_name, 'config', 'stevensIDM', '{}.yaml'.format(controllers_name.perform(context)))
    ompl_planning_yaml = load_yaml(moveit_config_package_name, 'config', 'stevensIDM', 'ompl_planning.yaml')
