...
def get_xarm_robot_description_parameters(
    ...
    mod = load_python_launch_file_as_module(os.path.join(get_package_share_directory('xarm_description'), 'launch', 'lib', 'stevensARM_description_lib.py'))
    ...
    return {
        ...
        'robot_description_planning': load_yaml(moveit_config_package_name, 'config', 'stevensARM', 'joint_limits.yaml'),
        'robot_description_kinematics': load_yaml(moveit_config_package_name, 'config', 'stevensARM', 'kinematics.yaml')
    }
